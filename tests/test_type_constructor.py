...
class TestTypeConstructor:
        ...
        expected = [
            Race(
                ...
                date=datetime.datetime(
                    year=2022, month=3, day=20, hour=15, tzinfo=datetime.timezone.utc
                ),
                results=[],
                first_practice=datetime.datetime(
                    year=2022, month=3, day=18, hour=12, tzinfo=datetime.timezone.utc
                ),
                second_practice=datetime.datetime(
                    year=2022, month=3, day=18, hour=15, tzinfo=datetime.timezone.utc
                ),
                third_practice=datetime.datetime(
                    year=2022, month=3, day=19, hour=12, tzinfo=datetime.timezone.utc
                ),
                sprint=None,
                sprint_results=[],
                qualifying=datetime.datetime(
                    year=2022, month=3, day=19, hour=15, tzinfo=datetime.timezone.utc
                ),
                qualifying_results=[],
                pit_stops=[],
                laps=[],
    ...
    def test_construct_statuses(self):
        ...
        params = [{"statusId": "1", "count": "1", "status": "Finished"}]

        expected = [Status(status_id=1, count=1, status="Finished")]
