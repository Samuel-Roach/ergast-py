...
class TestRequester:
    ...
    def test_get_statuses(self):
        ...
        expected = [{"statusId": "11", "count": "1", "status": "+1 Lap"}]
    ...
    def test_get_laps(self):
                ...
                "Laps": [
                    {
                        "number": "1",
                        "Timings": [
                            {"driverId": "alonso", "position": "5", "time": "1:57.681"}
                        ],
                    }
                ],
            }
        ...
        params = self._construct_test_params(
            season=2008, round_no=5, driver="alonso", lap=1
        )
    ...
    def test_get_pit_stops(self):
        ...
        params = self._construct_test_params(
            season=2021, round_no=16, driver="alonso", pit_stop=1
        )
